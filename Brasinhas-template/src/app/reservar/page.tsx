          ...
          {submitted ? (
            ...
            >
              ...
              <motion.button
                ...
                whileTap={{ scale: 0.97 }}
                className="border border-white/20 text-white/70 hover:text-white text-xs uppercase tracking-widest py-3 px-8 rounded-full transition-colors cursor-pointer"
              >
                Nova Reserva
              </motion.button>
            </motion.div>
            ...
            >
              ...
              >
                ...
                <motion.button
                  ...
                  className="w-full bg-brand-600 hover:bg-brand-500 text-white font-sans text-xs uppercase tracking-widest py-5 rounded-full shadow-[0_10px_30px_rgba(234,88,12,0.3)] hover:shadow-[0_20px_50px_rgba(249,115,22,0.4)] transition-all disabled:opacity-60 disabled:cursor-not-allowed cursor-pointer flex items-center justify-center gap-3"
                >
                  {loading ? (
                    <>
                      <motion.span
